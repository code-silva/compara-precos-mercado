...
class MercadoFilial(models.Model):
    ...
    mercado_matriz = models.ForeignKey(MercadoMatriz, on_delete=models.CASCADE, related_name='filiais')
...
class Produto_Oferta_Filial(models.Model):
    ...
    mercado_filial = models.ForeignKey(MercadoFilial, on_delete=models.CASCADE, related_name='ternario')
